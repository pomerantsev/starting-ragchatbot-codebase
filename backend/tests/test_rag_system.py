...
class TestRAGSystemContentQueries:
    ...
    def test_successful_content_query_with_results(self):
        ...
        mock_sources = [{"text": "Python Basics - Lesson 1", "link": "http://example.com/lesson1"}]
        ...
        assert "Answer this question about course materials: What is Python programming?" in call_args["query"]
    ...
    def test_tool_definitions_passed_to_ai_generator(self):
        ...
        self.mock_ai_generator.generate_response.return_value = "Found Python content..."
        self.mock_tool_manager.get_last_sources.return_value = []
    ...
    def test_special_characters_in_query(self):
        ...
        self.mock_ai_generator.generate_response.return_value = "Python handles variables..."
        self.mock_tool_manager.get_last_sources.return_value = []
...
class TestRAGSystemQueryFlow:
    ...
    @patch('rag_system.AIGenerator')
    @patch('rag_system.SessionManager')
    def test_query_flow_integration(self, mock_session_mgr_class, mock_ai_gen_class, 
                                   mock_vector_store_class, mock_doc_processor_class):
        ...
        mock_ai_generator.generate_response.return_value = "Python is a versatile programming language."
