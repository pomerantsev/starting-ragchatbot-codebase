...
class TestCourseSearchToolExecute:
    ...
    def test_successful_search_with_course_filter(self):
        ...
        self.mock_vector_store.search.return_value = mock_results
        self.mock_vector_store.get_lesson_link.return_value = "https://example.com/lesson3"
    ...
    def test_successful_search_with_both_filters(self):
        ...
        # Act
        result = self.search_tool.execute("specific", course_name="Python Advanced", lesson_number=5)
    ...
    def test_empty_results_with_both_filters(self):
        ...
        # Act
        result = self.search_tool.execute("content", course_name="Test Course", lesson_number=5)
